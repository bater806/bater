...
# (248 مجال × منصتين = 496 عملية بحث بالتشغيلة الوحدة)
#
...
CATEGORIES = [
    ...
    "ملابس محجبات كاجوال", "طرح وشيلان", "ملابس سباحة محتشمة",
    "أحذية نسائية مريحة", "جوارب وكولون", "اكسسوارات شعر",
    "باروكات وشعر مستعار", "معطرات سيارات", "معطرات ومنعمات ملابس",
    "مبيدات حشرية منزلية", "مطهرات ومعقمات", "كمامات وقفازات طبية",
    "أجهزة قياس طبية منزلية", "كراسي تدليك كهربائية",
    "أجهزة تبخير وترطيب", "سخانات مياه", "مضخات مياه ومسابح",
    "تفصيل أثاث خشبي", "أرفف ومنظمات منزلية", "صناديق تخزين بلاستيكية",
    "مظلات وستائر خارجية", "عشب صناعي وديكور حدائق", "برك سباحة منزلية",
    "ألعاب مائية للأطفال", "سكوترات ودراجات أطفال",
    "كراسي سيارة للأطفال", "أراجيح وألعاب حدائق",
    "خلفيات وإضاءة تصوير منتجات", "حقائب لابتوب",
    "أقلام فاخرة وهدايا مكتبية", "دفاتر ومنظمات يومية",
    "أختام وأدوات مكتبية", "مستلزمات تغليف مطاعم", "أكواب وأدوات تيك اواي",
    "آلات قهوة وإسبريسو منزلية", "غلايات وأطقم شاي", "أواني ضغط وطناجر",
    "سكاكين ومستلزمات شيف", "مآزر ومستلزمات مطبخ", "صناديق تبريد متنقلة",
    "مولدات كهرباء منزلية", "إنارة حدائق خارجية",
    "أنظمة إنذار ومراقبة منزلية", "أقفال ذكية", "معدات لحام وتلحيم",
    "أدوات نجارة وحدادة", "ورق حائط ودهانات", "مستلزمات تصميم داخلي",
    "مرايا ديكور", "أدوات تهوية ومراوح",
    "تلفزيونات وأنظمة صوت منزلي", "سماعات منزلية وهوم سينما",
    "أجهزة العاب فيديو كونسول", "أجهزة منزلية ذكية", "مكانس روبوت",
    "ريموتات تحكم عن بعد", "باور بانك وشواحن متنقلة",
    "أنظمة صوت السيارات", "طابعات ثلاثية الأبعاد",
    "نظارات الواقع الافتراضي", "ملابس مقاسات كبيرة",
    "ملابس أطوال طويلة وقصيرة", "زي طبي وسكرب", "سترات شتوية وجاكيتات",
    "جاكيتات جلد", "بليزر رسمي", "هوديز وسويت شيرت",
    "منتجات عضوية غذائية", "منتجات خالية من الجلوتين",
    "منتجات نباتية فيغن", "بهارات وأعشاب طبخ", "معلبات غذائية",
    "أطعمة مجمدة", "مياه ومشروبات معبأة", "مشروبات طاقة",
    "شوكولاتة وحلويات", "آيس كريم وحلويات مثلجة",
    "مستلزمات خبز ومكونات كيك", "فيتامينات ومعادن",
    "أدوات إسعافات أولية", "دعامات ومشدات طبية", "سماعات طبية للأذن",
    "مستلزمات عناية بالأسنان", "مستلزمات صحة الرضع",
    "زيوت عطرية وعناية بالذقن", "طلاء أظافر وأظافر صناعية",
    "مستحضرات تبييض الأسنان", "مستحضرات تسمير البشرة", "معدات غولف",
    "معدات تنس وبادل", "معدات كرة قدم", "معدات فنون قتالية",
    "معدات رماية بالسهام", "طاولات شطرنج وألعاب ذهنية",
    "أدوات رسم ثلاثي الأبعاد ونحت", "مجسمات وموديلات تجميع",
    "سيارات تحكم عن بعد", "آلات موسيقية", "كاميرات تصوير فيلم قديمة",
    "مستلزمات بونساي وحدائق مصغرة", "أحواض أسماك وزينة مائية",
    "تيراريوم ونباتات زجاجية", "مستلزمات أقفاص طيور",
    "مستلزمات زواحف أليفة", "مستلزمات تدريب وتنظيف حيوانات أليفة",
    "معدات تزلج وتزلج على الجليد", "مستلزمات تلميع وتفصيل سيارات",
    "كاميرات داش كام", "أنظمة إنذار سيارات",
    "قطع غيار سيارات دفع رباعي", "قطع غيار سيارات كلاسيكية",
    "اكسسوارات شحن سيارات كهربائية", "معدات تعقيم ومختبرات",
    "خدمات طباعة تجارية", "هدايا ترويجية للشركات", "زي موحد للشركات",
    "لوحات إرشادية وسلامة", "معدات مستودعات وتخزين",
    "أنظمة نقاط بيع", "عارضات ومستلزمات عرض المتاجر",
    "بطاقات سفر وملصقات شنط", "محولات كهرباء للسفر",
    "حافظات جوازات سفر", "أحذية مشي طويل ورحلات",
    "ملابس خارجية للجبال", "أرضيات وباركيه", "سيراميك وبلاط",
    "خزائن مطبخ", "تجهيزات حمامات", "أبواب ونوافذ",
    "ستائر وبرادي داخلية", "سجاد صلاة ومستلزمات دينية", "كتب ومصاحف",
    "مستلزمات حج وعمرة", "مظلات وكراسي شاطئية",
    "دعوات زفاف وبطاقات مناسبات", "تنظيم حفلات ومناسبات",
    "أكشاك تصوير للحفلات", "هدايا توزيعات أفراح",
    "مستلزمات ريزن وإيبوكسي", "فخار وسيراميك يدوي",
    "سكرابوكينج وألبومات صور", "واقيات شاشة للجوال", "جرابات تابلت",
    "شواحن لاسلكية", "خواتم ذكية", "أساور لياقة ذكية",
    "حفاضات ومستلزمات تنظيف رضع", "حليب أطفال ومستلزمات رضاعة",
...
DELAY_BETWEEN_SEARCHES = 5  # ثواني - مهم جداً عشان ما تنحظر من محرك البحث
